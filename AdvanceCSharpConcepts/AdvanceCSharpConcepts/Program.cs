...
using System.Linq;
using System.Text;
using System.Threading.Tasks;// Library used for Parallel processing 
    ...
    class Program
    {
        static void Main(string[] args)// main thread
        {
            ...
            /*  DelWelcome handlerWelcome = new DelWelcome(Welcome);
              ...
              //}*/
            #endregion
            #region AnonymousMethodsAndLambdaExpression
        ...
        #region AsyncAndAwait
         ...
         {
             Console.WriteLine("Waiting for Long Task to complete");
             System.Threading.Thread.Sleep(20000);
             Console.WriteLine("Executed Long Task");
         }
        #endregion
    }
}
